                                ...
                                <?php if ($config['type'] == 'text') { ?>
                                    ...
                                    echo TinyMCE::widget([
                                        'clientOptions' => [
                                            ...
                                            'toolbar' => 'styleselect insertfile undo redo | fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link  image media | code  print | forecolor backcolor fullscreen',
