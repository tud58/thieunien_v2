...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function check_role(){
        if(!empty($this->role_id)){
            if(Yii::$app->user->getIdentity()->role_id != ROLE_ADMIN && ($this->role_id == ROLE_ADMIN || $this->role_id == ROLE_CONTRIBUTOR)){
                $this->addError("role_id", "Chỉ admin mới được tạo/sửa tài khoản admin hoặc contributor");
            }
        }      
    }
